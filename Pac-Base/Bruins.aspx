<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bruins.aspx.cs" Inherits="Pac_Base.Bruins" %>
...
<body>
    <p style="text-align: center">
        <span class="auto-style1">University of California, Los Angeles Bruins</span></p>
    <p style="text-align: center">
        <img src="https://www.logolynx.com/images/logolynx/5d/5dca12f3c4b4b6adc23cc8b459771263.png" style="height: 250px; width: 438px" /><br />
    </p>
    <script runat="server">
        ...
        <div style="text-align: left">
            <asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#990000" StaticSubMenuIndent="1px" Orientation="Horizontal" RenderingMode="Table" style="font-size: medium" Width="100%">
                ...
                <Items>
                    ...
                    <asp:MenuItem NavigateUrl="~/Bruins.aspx" Text="TEAM" Value="TEAM">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [SEASONREC] WHERE ([Tid] = @Tid)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="7" Name="Tid" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
...
">
                <SelectParameters>
                    <asp:Parameter DefaultValue="7" Name="Aid" Type="Int32" />
                    <asp:Parameter DefaultValue="7" Name="Hid" Type="Int32" />
