<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Huskies.aspx.cs" Inherits="Pac_Base.Huskies" %>
...
<body>
    <p style="text-align: center">
        <span class="auto-style1">University of Washington Huskies</span></p>
    <p style="text-align: center">
        <img src="https://www.logolynx.com/images/logolynx/bf/bfbeb8e6d22c78dc07e683c9c5607e25.png" style="height: 250px; width: 250px" /><br />
    </p>
    <script runat="server">
    ...
    <form id="form1" runat="server">
        <div style="text-align: left">
            <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" StaticSubMenuIndent="10px" Orientation="Horizontal" RenderingMode="Table" style="font-size: medium" Width="100%">
                ...
                <Items>
                    ...
                    <asp:MenuItem NavigateUrl="~/Huskies.aspx" Text="TEAM" Value="TEAM">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [SEASONREC] WHERE ([Tid] = @Tid)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="10" Name="Tid" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" DataSourceID="SqlDataSource2" GridLines="None" CellSpacing="1">
                <Columns>
        ...
        <strong><span class="auto-style2">COACH</span></strong><br />
                <asp:DetailsView ID="DetailsView3" runat="server" AutoGenerateRows="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" DataSourceID="SqlDataSource6" GridLines="None" Height="50px" Width="125px" CellSpacing="1">
        ...
        <p>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="3" DataSourceID="SqlDataSource3" GridLines="None" AllowSorting="True" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1">
                <Columns>
...
">
                <SelectParameters>
                    <asp:Parameter DefaultValue="10" Name="Hid" Type="Int32" />
        ...
        <p>
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="3" DataSourceID="SqlDataSource7" GridLines="None" AllowSorting="True" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1">
                <Columns>
                    <asp:BoundField DataField="Away" HeaderText="Opponent" SortExpression="Away" />
