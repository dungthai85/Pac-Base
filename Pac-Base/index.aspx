...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p class="auto-style2" dir="ltr" style="line-height: 1.38; text-indent: 36pt; margin-top: 0pt; margin-bottom: 0pt;">
            <span class="auto-style3" style="font-family: 'Times New Roman'; color: #000000; background-color: transparent; font-weight: 400; font-style: normal; font-variant: normal; text-decoration: none; vertical-align: baseline; white-space: pre; white-space: pre-wrap; text-align: left;">Pac-base was built in response to requests from fans who support a team from the Pac-12 Conference. Our database can accomplish many of the capabilities that other sports systems can do including allowing fans to be able to view any information about their favorite team from performances to the matches, the coach of the team, and track players’ statistics. In order to provide the information about their preferred team in the Pac-12 quickly and expertly, we structured our database efficiently to provide the most positive experience. In addition, using data analysis to provide a prediction of future matches in winning percentage form.</span></p>
        <p class="auto-style2" dir="ltr" style="line-height:1.38;text-indent: 36pt;margin-top:0pt;margin-bottom:0pt;">
            &nbsp;</p>
        <p class="auto-style2" dir="ltr" style="line-height:1.38;text-indent: 36pt;margin-top:0pt;margin-bottom:0pt;">
            &nbsp;</p>
