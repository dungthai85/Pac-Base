<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Utes.aspx.cs" Inherits="Pac_Base.Utes" %>
...
<body>
    <p style="text-align: center">
        <span class="auto-style1">University of Utah Utes</span></p>
    <p style="text-align: center">
        <img src="https://www.logolynx.com/images/logolynx/64/64d3bf19af3b94780f336e78c99666c5.png" style="height: 250px; width: 290px" /><br />
    </p>
    <script runat="server">
        ...
        <div style="text-align: left">
            <asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#990000" StaticSubMenuIndent="1px" Orientation="Horizontal" RenderingMode="Table" style="font-size: medium" Width="100%">
                ...
                <Items>
                    ...
                    <asp:MenuItem NavigateUrl="~/Utes.aspx" Text="TEAM" Value="TEAM">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [SEASONREC] WHERE ([Tid] = @Tid)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="9" Name="Tid" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
...
">
                <SelectParameters>
                    <asp:Parameter DefaultValue="9" Name="Aid" Type="Int32" />
                    <asp:Parameter DefaultValue="9" Name="Hid" Type="Int32" />
