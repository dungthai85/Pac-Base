<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Beavers.aspx.cs" Inherits="Pac_Base.Beavers" %>
...
<body>
    <p style="text-align: center">
        <span class="auto-style1">Oregon State Beavers</span></p>
    <p style="text-align: center">
        <img src="https://www.logolynx.com/images/logolynx/51/51d1bfe1702359a4814587b3e06e7efc.jpeg" style="height: 250px" /><br />
    </p>
        ...
        <div style="text-align: left">
            <asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#990000" StaticSubMenuIndent="1px" Orientation="Horizontal" RenderingMode="Table" style="font-size: medium" Width="100%">
                ...
                <Items>
                    ...
                    <asp:MenuItem NavigateUrl="~/Beavers.aspx" Text="TEAM" Value="TEAM">
