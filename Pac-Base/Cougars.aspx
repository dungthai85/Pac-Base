<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cougars.aspx.cs" Inherits="Pac_Base.Cougars" %>
...
<body>
    <p style="text-align: center">
        <span class="auto-style1">Washington State University Cougars</span></p>
    <p style="text-align: center">
        <img src="https://www.logolynx.com/images/logolynx/2d/2d9f705b4ca8b03aff23087ddc576fdb.png" style="height: 260px; width: 500px" /><br />
    </p>
    <script runat="server">
        ...
        <div style="text-align: left">
            <asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#990000" StaticSubMenuIndent="1px" Orientation="Horizontal" RenderingMode="Table" style="font-size: medium" Width="100%">
                ...
                <Items>
                    ...
                    <asp:MenuItem NavigateUrl="~/Cougars.aspx" Text="TEAM" Value="TEAM">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [SEASONREC] WHERE ([Tid] = @Tid)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="11" Name="Tid" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
...
">
                <SelectParameters>
                    <asp:Parameter DefaultValue="11" Name="Aid" Type="Int32" />
                    <asp:Parameter DefaultValue="11" Name="Hid" Type="Int32" />
