<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cardinals.aspx.cs" Inherits="Pac_Base.Cardinals" %>
...
<body>
    <p style="text-align: center">
        <span class="auto-style1">Standford University Cardinals</span></p>
    <p style="text-align: center">
        <img src="https://www.logolynx.com/images/logolynx/6f/6fa77f845d705ad44dcc414e45f9927f.png" style="height: 250px; width: 275px" /><br />
    </p>
    <script runat="server">
        ...
        <div style="text-align: left">
            <asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#990000" StaticSubMenuIndent="1px" Orientation="Horizontal" RenderingMode="Table" style="font-size: medium" Width="100%">
                ...
                <Items>
                    ...
                    <asp:MenuItem NavigateUrl="~/Cardinals.aspx" Text="TEAM" Value="TEAM">
...
">
                <SelectParameters>
                    <asp:Parameter DefaultValue="6" Name="Aid" Type="Int32" />
                    <asp:Parameter DefaultValue="6" Name="Hid" Type="Int32" />
